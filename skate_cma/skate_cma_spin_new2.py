...
from skate_cma.hpcma3 import HpCma
...
def objective(i, penalty_option0, penalty_option1, penalty_weight):
    ...
    # penalty_weight[PenaltyType.LEFT_FOOT_HEGIHT] = 5.
    ...
    penalty_weight[PenaltyType.MAX_Y_RIGHT_FOOT_HEEL_END] = 1.0
    ...
    if i == 0:
        ...
        penalty_option1[PenaltyType.MAX_Y_ANGULAR_MOMENTUM_RIGHT_TOE_END] = True
        penalty_option1[PenaltyType.MAX_Y_RIGHT_FOOT_HEEL] = True
        penalty_option1[PenaltyType.MAX_Y_RIGHT_FOOT_HEEL_END] = True
        # penalty_option1[PenaltyType.LEFT_FOOT_HEGIHT] = 0.3
        ...
        penalty_option0[PenaltyType.MAX_Y_ANGULAR_MOMENTUM_RIGHT_TOE_END] = True
        penalty_option0[PenaltyType.MAX_Y_RIGHT_FOOT_HEEL] = True
        penalty_option0[PenaltyType.MAX_Y_RIGHT_FOOT_HEEL_END] = True
        # penalty_option0[PenaltyType.LEFT_FOOT_HEGIHT] = 0.3
        ...
        # spin
        penalty_option0[PenaltyType.MAX_Y_ANGULAR_MOMENTUM_RIGHT_TOE] = True
        penalty_option0[PenaltyType.MAX_Y_RIGHT_FOOT_HEEL] = True
...
if __name__ == '__main__':
    pydart.init()
    if len(sys.argv) == 1:
        cma = HpCma('hmr_skating_spin_resubmit', 24, sigma=0.1, max_time=3.6, cma_timeout=1800)
    elif len(sys.argv) == 5:
        ...
        cma = HpCma('hmr_skating_spin_resubmit', 1)
