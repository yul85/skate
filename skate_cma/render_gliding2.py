...
def main():
    ...
    # for bvh file
    bvh_qs = []
    bvh_file_name = 'gliding2.bvh'
    skel_file_name = 'gliding2.skmo'
    ...
    x = [x0t]
    # file_path = 'hmr_skating_gliding2_model_201908221432/xbest.skcma'    # com vel = [0.5, 0.0, +-0.05]
    # file_path = 'hmr_skating_gliding2_model_201908221551/xbest.skcma'    # com vel = [0.5, 0.0, +-0.005]
    file_path = 'hmr_skating_gliding2_model_201908222150/xbest.skcma'
