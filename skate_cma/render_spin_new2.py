...
def main():
    ...
    # env_name = 'hmr_skating_spin_new'
    env_name = 'hmr_skating_spin_resubmit'
    max_time = 3.6

    # env_name = 'hmr_skating_spin_new1'
    # max_time = 2.3
    ...
    # file_path = 'hmr_skating_spin_new2_model_201905310542/xbest.skcma'
    # file_path = 'hmr_skating_spin_new2_model_201905310720/xbest.skcma'
    # file_path = 'hmr_skating_spin_new2_model_201905310825/xbest.skcma'              #best
    # file_path = 'hmr_skating_spin_new2_model_201905311034/xbest.skcma'
    # file_path = 'hmr_skating_spin_new2_model_201905311210/xbest.skcma'              # KICK

    # file_path = 'hmr_skating_spin_new2_model_201905311318/xbest.skcma'
    # file_path = 'hmr_skating_spin_new2_model_201906010824/xbest.skcma'

    # add spin2 ======================================================================

    # file_path = 'hmr_skating_spin_new4_model_201906032302/xbest.skcma'
    # file_path = 'hmr_skating_spin_new5_model_201906041119/xbest.skcma'

    file_path = 'hmr_skating_spin_resubmit_model_201906191059/xbest.skcma'

    # file_path = 'hmr_skating_spin_new1_model_201906131725/xbest.skcma'
