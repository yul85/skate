...
from SkateUtils.NonHolonomicWorld import NHWorldV3
import numpy as np
import gym
import gym.spaces
import copy
...
class SkateDartEnv(gym.Env):
    def __init__(self, env_name='speed_skating'):
        self.world = NHWorldV3(1./1200., '../data/skel/skater_3dof_with_ground.skel')
        ...
        self.ref_world = NHWorldV3(1./1200., '../data/skel/skater_3dof_with_ground.skel')
